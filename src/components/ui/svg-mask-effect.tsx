    ...
    >
      ...
      >
        ...
        <div
          ...
          className="max-w-4xl mx-auto text-center text-greyText  text-4xl font-bold relative z-20"
        >
          {children}
        </div>
      </motion.div>

      <div className="w-full h-full flex items-center justify-center  text-greyText">
        {revealText}
      </div>
    </motion.div>
  );
